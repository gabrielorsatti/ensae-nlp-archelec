...
- **Fighting words**: Log-odds ratio analysis (Monroe, Colaresi & Quinn, 2008) revealing how different parties frame the same topics — how the PS and the FN talk about unemployment using entirely different lexicons even when discussing the same economic reality.
